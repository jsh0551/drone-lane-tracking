...
RADIOUS = dst_threshold
D1, D2 = 100, 30 # current distance
MV1, MV2 = 100 - RADIOUS, 20 - RADIOUS# target moving
K = math.log(MV1/MV2, D1/D2)
ALPHA = MV1/np.power(D1,K)

def calMove(dst):
    move = RADIOUS + ALPHA * np.power(dst, K)
    return min(move, 100-RADIOUS)
