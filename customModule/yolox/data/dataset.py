...
class COCODataset(torch.utils.data.Dataset):
    ...
    def __init__(self, cfg, img_size=(640, 640), name="train", json_file="train.json", preproc=None,
...
def main():
    ...
    opt.dataset_path = "/home/admin957/carla/DQLL/yolox/data/dataset/coco"
    opt.train_ann = opt.dataset_path + "/annotations/train.json"
    opt.val_ann = opt.dataset_path + "/annotations/val.json"
